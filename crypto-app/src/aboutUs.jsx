...
return (
    <>
        ...
        <h2 id="aboutus-heading" className="block-el">WHY <span style={{color:"yellow"}}>CHOOSE US</span></h2>
        <div id="aboutus-container">
            {/*AboutUs Left Section */}
            <div id="container-left">
            <div className="container-stuff" className="block-el">
           ...
           {/*About Us Middle Image */}
            <img src={AUP} alt="About Us Image" id="aup-pic" className="block-el"/>
